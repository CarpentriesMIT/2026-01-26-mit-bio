...
venue: "Carpentries @ MIT: Programming with Python. Bootcamp for the Biology Department IAP 2026"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "MIT Department of Biology"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
helper: ["Ondine Atwa", "Matt Bernhardt", "Juana De La O", "Ece Turnator"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
